...
1. `docker.yml` contains general docker variables (puid/pgid/networks) 
...
With this you could have role defaults used throughout the role, and then could point them to group_vars. I simply prefer to have as few variables as possible.
...
When I want to [copy a file](https://drjoyce.blog/common/#file-copy) for a service, I include them in the role/files folder, for example:
...
Above, the themes files for my Hugo blog are copied during the play to the hugo/static folder. I restrict copy tasks to files I won't be expected to change or edit.
